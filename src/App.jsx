...
const NORMAL_EXTRA_QUESTIONS = [
  // ── Deductive Reasoning ────────────────────────────────────────
  { id: 451, question: "The dog show had one first-place winner, two second-place winners, and three third-place winners. The Poodle was not the first-place winner. The Great Dane finished between the Chihuahua and the Labrador (in some order). The Sheepdog and the Terrier did not win the same prize as each other.\n\nWhich dog could not have finished in second place?", choices: ["Terrier", "Great Dane", "Poodle"], correct: 2, category: "Logic", subcategory: "Deductive Reasoning", options: 3 },
  { id: 452, question: "Five friends are sitting in a row. Jim is in a seat to the left of Teresa, but to the right of Bjorn. Bjorn is in a seat immediately to the left of Phil. Scott is in a seat next to Teresa.\n\nWho can be seated second from the right?", choices: ["Only Teresa", "Only Jim", "Teresa or Scott", "Jim or Teresa", "Anyone"], correct: 2, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  { id: 453, question: "Ari, Blaire, Chris, Dina, Eli, Fay, and Gal have a focal meeting with their team manager. They are to enter one after the other, not necessarily in this order. Chris enters immediately before Dina. Gal enters sometime after Chris. There are exactly two workers who enter between Ari and Eli. Ari is the second to enter the meeting room.\n\nWho entered the room third?", choices: ["Fay", "Chris", "Dina", "Gal", "None of the above"], correct: 1, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  { id: 454, question: "At Intech LTD, six product managers are scheduled to deliver a quarterly summary — Prudence, Chloe, Harriette, Lia, Maurice and Gale, not necessarily in this order. Chloe is scheduled to deliver her presentation after Harriette. Gale is scheduled after Lia. Lia is scheduled three slots after Prudence. Harriette is either scheduled on the first or the third slot.\n\nWhich of the following is a complete list of managers who can deliver on the second slot?", choices: ["Prudence", "Maurice", "Maurice, Chloe, Prudence", "Chloe, Maurice", "Maurice, Prudence"], correct: 4, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  { id: 455, question: "The F train has more cars than the R train. The V train has the most cars. The Q train has fewer cars than the R train. The H train has fewer cars than the F train.\n\nWhich of the following must be true?", choices: ["The H train has the second-greatest number of cars", "The R and H trains have the same number of cars", "The Q train has the smallest number of cars", "The V train has more cars than the H train", "The Q train has more cars than the F train"], correct: 3, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  { id: 456, question: "Five detectives were employed this year, and each detective solved at least one case. Alvin solved three times as many cases as Edward. Betty solved three fewer cases than Edward. Duncan and Betty solved three total cases. Claire solved the most cases.\n\nWhich of the following must be true?", choices: ["The smallest possible number of combined solved cases is under 30", "Edward solved exactly twice as many cases as Duncan", "Claire solved at least four times as many cases as Duncan", "Betty, Edward and Duncan combined to solve more cases than Alvin", "Alvin solved the third-most number of cases"], correct: 0, category: "Logic", subcategory: "Deductive Reasoning", options: 5 }, // VERIFY (A and C both true — A is min=28<30)
  { id: 457, question: "Phil made a sales trip to five cities. He visited Baltimore sometime between his visit to Honolulu and Tulsa (or Tulsa and Honolulu). He visited Tulsa immediately before he visited Miami. He visited Seattle either first or last.\n\nWhich of the following must be false?", choices: ["Phil visited Miami immediately before Honolulu", "Phil visited Honolulu immediately before Seattle", "Phil visited Baltimore second", "Phil's first visit was not to Miami", "Phil visited Seattle and Honolulu on consecutive visits"], correct: 0, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  { id: 458, question: "A student can graduate early, on time or late. No more than two students graduated at any one time. Rocky graduated sometime after Viola. Neither Ulysses nor Tilly graduated early. Sarah and Walter graduated at different times.\n\nWhich of the following must be false?", choices: ["Rocky graduated on time", "Viola graduated on time", "Tilly graduated late", "Walter graduated early", "Sarah and Ulysses graduated together"], correct: 1, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  { id: 459, question: "Adam the Astronaut visited four planets. He visited Jupiter and Venus back-to-back (though not necessarily in that order). He visited Neptune sometime before Mercury.\n\nWhich of the following must be false?", choices: ["Adam visited Jupiter last", "Adam visited Mercury last", "Adam visited Mercury immediately before Jupiter", "Adam visited Venus third", "Adam visited Neptune second"], correct: 4, category: "Logic", subcategory: "Deductive Reasoning", options: 5 },
  ...
  // ── Word Relationships ─────────────────────────────────────────
  { id: 462, question: "Mend; Amend\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 463, question: "Candid; Candidate\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 2, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 464, question: "Epitome; Incarnation\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 465, question: "Barter; Exchange\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 466, question: "Impose; Pose\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 2, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 467, question: "Adequate; Sparse\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 1, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 468, question: "Apparent; Evident\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 469, question: "Follow; Lead\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 1, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 470, question: "Assured; Bashful\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 1, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 471, question: "Dissent; Dispute\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 472, question: "Expansive; Extensive\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 473, question: "Coarse; Smooth\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 1, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 474, question: "Determined; Resolute\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 0, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  { id: 475, question: "Adamant; Flexible\n\nThe two words above", choices: ["have similar meanings", "have contradictory meanings", "have neither similar nor contradictory meanings"], correct: 1, category: "Verbal", subcategory: "Word Relationships", options: 3 },
  ...
  // ── Math Word Problems ─────────────────────────────────────────
  { id: 482, question: "Six batteries weigh 72 grams. How much does one battery weigh?", choices: ["12gr", "8gr", "15gr", "6gr", "10gr"], correct: 0, category: "Math", subcategory: "Word Problems", options: 5 },
  { id: 483, question: "A packet of chewing gum costs £1.35. If Lewis wishes to buy 4 packs of gum, how much will this cost him?", choices: ["£4.35", "£5.40", "£5.70", "£6.35", "£4.95"], correct: 1, category: "Math", subcategory: "Word Problems", options: 5 },
  { id: 484, question: "Charlotte sold 60 glasses of homemade lemonade and earned £90. How much would she have earned from selling 15 of those glasses?", choices: ["£15.5", "£19", "£22.5", "£25", "£25.5"], correct: 2, category: "Math", subcategory: "Word Problems", options: 5 },
  { id: 485, question: "Donald weighs four times more than Mickey. Mickey weighs thirty times more than Andy. What is the weight ratio between Donald and Andy?", choices: ["90:8", "120:1", "30:4"], correct: 1, category: "Math", subcategory: "Word Problems", options: 3 },
  { id: 486, question: "A café uses 840 eggs per month for its breakfast menu. If the supplier charges $2.40 per dozen eggs, and then increases the price to $3.00 per dozen, how much more will the café spend on eggs each month?", choices: ["$42", "$35", "$50.4", "$42.5", "$60"], correct: 0, category: "Math", subcategory: "Word Problems", options: 5 },
  { id: 487, question: "With 32 tennis league games behind him, Joe has a win:loss ratio of 1:3. How many games must he win in a row in order to have a win:loss ratio of 1:2?", choices: ["4", "5", "2", "3", "6"], correct: 0, category: "Math", subcategory: "Word Problems", options: 5 },
  { id: 488, question: "Rebecca ate 4 times as many cherries as Charlie did. In total, they both ate 30 cherries. How many cherries did Rebecca eat?", choices: ["24", "20", "28", "34", "26"], correct: 0, category: "Math", subcategory: "Word Problems", options: 5 },
  ...
  { id: 493, question: "1,200 students are enrolled at a school. On one day, 4% of students were away on a trip. How many students were in school on that day?", choices: ["48", "62", "1152", "1150", "1196"], correct: 2, category: "Math", subcategory: "Percentages", options: 5 },
  { id: 494, question: "A shop donates 5% of all earnings to charity. How much would the shop donate to charity from a purchase worth £30?", choices: ["£1.2", "£1.5", "£0.3", "£15", "£2.5"], correct: 1, category: "Math", subcategory: "Percentages", options: 5 },
  { id: 495, question: "The cost of filling up Sam's petrol tank was $40. The price of petrol then increased by 45%. How much more does Sam need to pay now?", choices: ["$18", "$56", "$16", "$22", "$58"], correct: 0, category: "Math", subcategory: "Percentages", options: 5 },
  { id: 496, question: "Zach's parents reduced his weekly pocket money from £20 to £15. What is the percentage decrease?", choices: ["75%", "15%", "30%", "25%", "20%"], correct: 3, category: "Math", subcategory: "Percentages", options: 5 },
  ...
  { id: 498, question: "Ron planned to purchase 15 bottles of his favorite wine at $25 per bottle. However, the price of a wine bottle increased by 20% and Ron decided to not exceed his budget. How many bottles could Ron purchase at the new price?", choices: ["14", "13", "12", "11", "None of the above"], correct: 2, category: "Math", subcategory: "Word Problems", options: 5 },
  // ── Probability & Combinatorics ────────────────────────────────
  { id: 499, question: "90% of the bolts manufactured in a production line comply with the industry's standard, of which 80% are at a premium standard. If a bolt is chosen arbitrarily, what are the chances it will conform to premium standards?", choices: ["18%", "72%", "40%", "36%", "85%"], correct: 1, category: "Math", subcategory: "Probability", options: 5 },
  { id: 500, question: "Ruby has 3 pairs of shoes — black, silver, white — and two pairs of trousers — black and white. If she chooses one pair of shoes and one pair of trousers arbitrarily, what are the chances that both items will be in the same color?", choices: ["1/3", "2/5", "1/5", "4/5", "1/6"], correct: 0, category: "Math", subcategory: "Probability", options: 5 },
  ...
  { id: 504, question: "Dave has a three-digit combination lock. Each digit is one of the numbers 0, 1, 2, 3, 4 and digits can repeat in the code. How many different combinations does Dave have for setting his code?", choices: ["120", "119", "125", "124", "122"], correct: 2, category: "Math", subcategory: "Combinatorics", options: 5 },
  { id: 505, question: "Peggy has a doll clothing set that includes the following apparel items: 4 skirts, 3 shoes, 3 shirts, and 3 socks. How many dressing options does Peggy have for her doll, given that she must use one item of each type?", choices: ["108", "13", "36", "96", "27"], correct: 0, category: "Math", subcategory: "Combinatorics", options: 5 },
  ...
  { id: 508, question: "Collin needs to cover a 3m by 5m room floor and was offered two options:\n\nOffer A: $4 per tile, tile size 0.25m × 0.5m\nOffer B: $3 per tile, tile size 0.5m × 0.5m\n\nWhat is the total price of the cheaper offer?", choices: ["$120", "$160", "$180", "$200", "$360"], correct: 2, category: "Math", subcategory: "Geometry", options: 5 },
...
const NORMAL_ALL = [...TEST_NEW_QUESTIONS, ...TEST2_NORMAL_QUESTIONS, ...NORMAL_EXTRA_QUESTIONS];
